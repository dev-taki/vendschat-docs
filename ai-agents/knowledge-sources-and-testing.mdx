...
<Frame caption="Knowledge Sources on the train form">
  <img src="/images/ai-agent-knowledge.png" alt="Vendschat Train AI Agent form showing Response Delay and Knowledge Sources with Add knowledge source, plus Create agent." />
</Frame>
...
<Frame caption="Test AI Agent sandbox">
  <img src="/images/ai-agent-test.png" alt="Vendschat Sales Agent detail on the left and Test AI Agent sandbox on the right with a greeting and a Type your message field." />
</Frame>
